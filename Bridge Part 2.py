...
if __name__ == "__main__":
    ...
    1: (1.27, 2.54, 82.53999999999999, 81.27),
    4: (1.27, 2.54, 82.53999999999999, 81.27),
    0: (2.54, 100.0, 86.31, 83.81)}
    # ------------------  |
    # ------------------  |
    # ------------------  |   0
    #   ---        ---
    ...
    2: (80, 1.27, 41.27, 1.27),
    5: (80, 1.27, 41.27, 1.27),
    1: (1.27, 5.0, 82.53999999999999, 81.27),
    4: (1.27, 5.0, 82.53999999999999, 81.27),
    0: (2.54, 100.0, 86.31, 83.81),
    7: (1.27, 100.0, 86.31, 83.81)}
    # ------------------  |
    # ------------------  |   0
    #   ---        ---
    #   ---        ---    | 1   4
