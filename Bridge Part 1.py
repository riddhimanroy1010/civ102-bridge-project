...
if __name__ == "__main__":
    ...
    shapes_and_dim = {0: (2.54, 100.0, 83.81, 82.54),
    1: (1.27, 10.0, 81.875, 81.27),
    2: (80.0, 2.54, 41.25, 1.27),
    3: (5.08, 10.0, 0.625, 0.0),
    4: (1.27, 10.0, 81.875, 81.27),
    5: (80.0, 2.54, 41.27, 1.27),
    6: (5.08, 10.0, 0.625, 0.0)}
    # ------------------  |
    # ------------------  |   0
    #   ---        ---    | 1   4
    #   -            -
    ...
    print("Plate buckling 1", plate_buckling_1_top())
    print("Plate buckling 2", plate_buckling_2_top())
    print("Web buckling", web_buckling())
    ...
    print("sheer interface", shear_interface(shapes_and_dim))
    print("Sheer buckling", shear_bukling(shapes_and_dim, 400))
